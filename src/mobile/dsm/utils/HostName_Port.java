 ...
 *
 */
public class HostName_Port {
	public static final int MASTERLISTENPORT = 1500;
	...
	public static final int MASTERPORT = 1555;
	// public static final String MASTER_MAIN_IP = "";
}
